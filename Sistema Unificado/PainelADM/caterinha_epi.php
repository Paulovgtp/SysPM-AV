                ...
                <div class="col-md-12 table-responsive pt-3" style="min-width: 480px;">
                    ...
                    <main role="main" class="col-md-12 col-lg-12 pt-3 px-4"
                        ...
                        <div id="main" class="container-fluid">
                            ...
                            <form action="biblioteca_pdf/index.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label> EQUIPAMENTO: <input class="form-control" type="text" name="obj" id="obj"
                                                placeholder="Ex: Capacete (123232) . . ." required></label>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label> ARMA: <input class="form-control" type="text" name="obj2" id="obj2"
                                                placeholder="Ex: Glock (117283) " required></label>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label> MUNIÇÃO: <input class="form-control" type="text" name="obj3" id="obj3"
                                                placeholder="Ex: 0.50 (20 PENTES)" required></label>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputEmail1">PARTE:</label>

                                        <textarea class="form-control" name="parte" id="parte" cols="30" rows="3"
                                            placeholder="Digite aqui..." required></textarea>

                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputEmail1">TERMO:</label>
                                        <textarea class="form-control" name="termo" id="termo" cols="30" rows="3"
                                            placeholder="Digite aqui..." required></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputEmail1">DECLARAÇÃO:</label>
                                        <textarea class="form-control" name="declaracao" id="declaracao" cols="30"
                                            rows="3" placeholder="Digite aqui..." required></textarea>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="exampleInputEmail1">Assinatura:</label><br>
