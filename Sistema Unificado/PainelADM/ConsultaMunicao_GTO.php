            ...
            ?>
              ...
              <tbody id="myTable">
                <tr>
                  ...
                  <td>
                    <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever1="<?= $linhas['modelo'] ?>" data-bs-whatever2="<?= $linhas['marca'] ?>" data-bs-whatever3="<?= $linhas['validade'] ?>" data-bs-whatever4="<?= $linhas['quantidade'] ?>" data-bs-whatever5="<?= $linhas['obs'] ?>   " data-bs-whatever6="<?= $linhas['id'] ?>">Editar</button>
                  </td>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="edit_municao.php" method="POST" onsubmit="return  verificar()">
