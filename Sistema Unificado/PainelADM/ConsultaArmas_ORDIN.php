      ...
      <div class="corpo-painel col-md-10" style="background-image: url(img/fundo.png);background-size: cover;height: 97vh;">
        ...
        <div class="table-responsive pt-3" style="min-width: 480px;">
          ...
          <table class="table table-bordered table-striped">
            ...
            $query = "SELECT  * FROM armas_ordinario";
            ...
            ?>
              ...
              <tbody id="myTable">
                <tr>
                  ...
                  <td><?php echo $linhas['LOCALIZAÇÃO'] ?></td>
                  <td><?php echo $linhas['SITUAÇÃO'] ?></td>
                  ...
                  <td style="display: flex;justify-content: space-around;flex-wrap: nowrap;">
                    <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="<?= $linhas['MODELO'] ?>" data-bs-whatever2="<?= $linhas['MARCA'] ?>" data-bs-whatever9="<?= $linhas['id'] ?>" data-bs-whatever7="<?= $linhas['SITUAÇÃO'] ?>" data-bs-whatever3="<?= $linhas['n_serie'] ?>" data-bs-whatever4="<?= $linhas['PATR'] ?>" data-bs-whatever5="<?= $linhas['LOCALIZAÇÃO'] ?>" data-bs-whatever6="<?= $linhas['CAUTELA'] ?>" data-bs-whatever8="<?= $linhas['OBS'] ?>">Editar</button>
